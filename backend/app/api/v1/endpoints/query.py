...
async def process_query(request: QueryRequest):
    ...
    return await process_text_query(session_id, request.query_text, request.llm_provider)
...
async def process_speech_query(
    ...
    session_id = "default_session"
    return await process_speech_query_service(session_id, audio_file, llm_provider)
